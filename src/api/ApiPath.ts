export const ApiPath = {
  ...
  UPDATE_CONVERSATION: getApiPath('conversations/'), // New endpoint for updating conversations
  ...
  UPDATE_CONVERSATION_DETAIL: getApiPath('conversation_details/update'), // Updated to match Swagger endpoint
